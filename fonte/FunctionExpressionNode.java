public class FunctionExpressionNode implements ExpressionNode{
	...
	public double getValue() throws Exception{
		switch(function){
			...
			case LOG:  return Math.log(argument.getValue()) * 0.43429448190325182765;
			case LOG2: return Math.log(argument.getValue()) * 1.442695040888963407360;
		}
		throw new Exception("Funcao invalida: " + function + "!");
	}
	...
	public static int stringToFunction(String str) throws Exception{
		...
		throw new Exception("Funcao inesperada " + str + "encontrada!");
	}
